...
export function getDb(): BetterSqlite3Database {
  ...
  // v4: Wipes embeddings generated by broken align.ts affine output (BUG 1 fix).
  //     Previous builds used .resize() after Sharp .affine(), squishing the entire
  //     image canvas to 112×112 instead of extracting the face region. All cached
  //     embeddings from v0.2.9 and earlier are garbage and must be recomputed.
